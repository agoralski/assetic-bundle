...
class AsseticTokenParser extends BaseAsseticTokenParser
{
    ...
    public function parse(\Twig_Token $token)
    {
        if ($this->templateNameParser && is_array($this->enabledBundles)) {
            ...
            try {
                /*
                dump(get_class_methods($this->parser->getStream()));
                dump($this->parser->getStream()->getCurrent());
                dump(get_class_methods($this->parser->getStream()->getSourceContext()));
                dump($this->parser->getStream());
                die();
                */
